...
const  { getPatient, addPatient, updatePatient, deletePatient, gePatientById,StatistiquePatient , globalPatient,getPatientInfoByCIN} = require('./patient/controllerpatient');
...
//router.get("/getPatientInfoByCIN/:cin", getPatientInfoByCIN);
